              ...
              <div className="px-8">
                ...
                <div className="">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="font-semibold text-sm">View loan requests</p>
                  ...
                  {/* <input
                    type="checkbox"
                    class="bg-white text-[#8003CD] border border-[#C0C0CF] rounded focus:ring-0 w-5 h-5 cursor-pointer"
                  /> */}
                  {/* <div className="flex gap-[6.25rem]">
                    <h1 className="text-xs font-bold text-[#8A8B9F] mb-3">
                      CREATE
                    </h1>
